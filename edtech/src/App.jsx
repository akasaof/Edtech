...
import AdminCourse from './adminAcess/formsComp/adminCourse.jsx'
  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/courseForm/:ops' element={<AdminCourse/>}/>
        <Route path='/courseForm/:ops/:id' element={<AdminCourse/>}/> */}
      </Routes>
    </BrowserRouter>
